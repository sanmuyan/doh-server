...
func initConfig(cmd *cobra.Command) error {
	...
	_ = viper.BindPFlag("udp_bind", cmd.Flags().Lookup("udp-bind"))
	_ = viper.BindPFlag("tcp_bind", cmd.Flags().Lookup("tcp-bind"))
	_ = viper.BindPFlag("cache", cmd.Flags().Lookup("cache"))
	_ = viper.BindPFlag("cache_ttl", cmd.Flags().Lookup("cache-ttl"))
	_ = viper.BindPFlag("upstream_server", cmd.Flags().Lookup("upstream-server"))
	_ = viper.BindPFlag("upstream_net", cmd.Flags().Lookup("upstream-net"))
	_ = viper.BindPFlag("upstream_timeout", cmd.Flags().Lookup("upstream-timeout"))
